...
class Authorization(object):
    def __init__(self, session, authorization_url, token_url, client_id,
                 client_secret, default_redirect_uri, default_scope_requested):
        """
        :param session: A dict-like persistent storage to put tokens into.
        ...
        :param default_scope_requested: string/unicode; space-separated permission-scopes requested.
        ...
        self.default_scope = default_scope_requested
